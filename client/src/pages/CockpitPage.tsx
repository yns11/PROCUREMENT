  ...
  return (
    <div className="page">
      ...
      <div className="grid kpis">
        ...
        <Kpi label="Articles avec commandes simulées" icon={<ShoppingCart size={14} />} tone="brand" value={k ? fmtInt(k.sim_order_articles) : <Skeleton w={40} h={28} />} meta="Calcul CBN" onClick={() => nav("/propositions")} />
